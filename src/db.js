...
var _model8 = require('./modules/Usermeta/model');

var _model9 = _interopRequireDefault(_model8);

var _model10 = require('./modules/Comment/model');

var _model11 = _interopRequireDefault(_model10);

var _model12 = require('./modules/Commentmeta/model');
  ...
  _createClass(WordExpressDatabase, [{
    ...
    value: function getModels() {
      ...
      return {
        ...
        Comment: (0, _model11.default)(Conn, prefix),
        Commentmeta: (0, _model13.default)(Conn, prefix),
        User: (0, _model6.default)(Conn, prefix),
        Usermeta: (0, _model9.default)(Conn, prefix),
    ...
    value: function getConnectors() {
      ...
      return _extends({}, (0, _connectors2.default)(models, this.settings), (0, _connectors4.default)(models), (0, _connectors6.default)(models), (0, _connectors8.default)(models), (0, _connectors10.default)(models), (0, _connectors12.default)(models, this.settings));
    }
  }]);
